...
async def hours_info(call: types.CallbackQuery):
    if call.data == "00:00":
        await call.message.answer(
            f"harorat: {UzbekistanWeather(open("city.txt")).today()[0]['bugun'][1]['3 soatlik harorat']['00:00']['harorat']}"
            f"havo: {UzbekistanWeather(open("city.txt")).today()[0]['bugun'][1]['3 soatlik harorat']['00:00']['havo']}"
            f"shamol tezligi: {UzbekistanWeather(open("city.txt")).today()[0]['bugun'][1]['3 soatlik harorat']['00:00']['shamol tezligi']}"
            f"""yog'ingarchilik: {UzbekistanWeather(open("city.txt")).today()[0]['bugun'][1]['3 soatlik harorat']['00:00']["yog'ingarchilik"]}"""
            f"namlik: {UzbekistanWeather(open("city.txt")).today()[0]['bugun'][1]['3 soatlik harorat']['00:00']['namlik']}"
            f"""yomg'ir yog'ish ehtimoli: {UzbekistanWeather(open("city.txt")).today()[0]['bugun'][1]['3 soatlik harorat']['00:00']["yomg'ir yog'ish ehtimoli"]}"""
        )
