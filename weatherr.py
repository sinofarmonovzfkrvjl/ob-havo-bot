...
class UzbekistanWeather:
    ...
    def today(self):
        if self.place.lower() == "toshkent":
            ...
            response = requests.get(f"https://www.ob-havo.com/asia/uzbekistan/tashkent/angren?page=today")
        elif self.place.lower() == "asaka":
            response = requests.get(f"https://www.ob-havo.com/asia/uzbekistan/andijan/asaka?page=today")
        elif self.place.lower() == "baliqchi":
            response = requests.get(f"https://www.ob-havo.com/asia/uzbekistan/andijan/baliqchi?page=today")
        elif self.place.lower() == "bekobod":
            response = requests.get(f"https://www.ob-havo.com/asia/uzbekistan/tashkent/bekobod?page=today")
        else:
        ...
        return [{"bugun": [
                    ...
                    {"3 soatlik harorat": {"00:00": {"harorat": necessary_things[0].text,
                                            ...
                                            "yogingarchilik": f"{necessary_things[16].text}{yogingarchilik[0].text}",
                                            "namlik": f"{necessary_things[24].text}%",
                                            "yomgir yogish ehtimoli": f"{necessary_things[8].text}%"},
                                "03:00": {"harorat": necessary_things[1].text,
                                            "havo": weather[1].text,
                                            "shamol tezligi": f"{necessary_things[32].text}{m_taqsin_s[1].text}",
                                            "yogingarchilik": f"{necessary_things[17].text}{yogingarchilik[1].text}",
                                            "namlik": f"{necessary_things[25].text}%",
                                            "yomgir yogish ehtimoli": f"{necessary_things[9].text}%"}, 
                                "06:00": {"harorat": necessary_things[2].text,
                                            "havo": weather[2].text,
                                            "shamol tezligi": f"{necessary_things[32].text}{m_taqsin_s[2].text}",
                                            "yogingarchilik": f"{necessary_things[18].text}{yogingarchilik[2].text}",
                                            "namlik": f"{necessary_things[26].text}%",
                                            "yomgir yogish ehtimoli": f"{necessary_things[10].text}%"}, 
                                "09:00": {"harorat": necessary_things[3].text,
                                            "havo": weather[3].text,
                                            "shamol tezligi": f"{necessary_things[32].text}{m_taqsin_s[3].text}",
                                            "yogingarchilik": f"{necessary_things[19].text}{yogingarchilik[3].text}",
                                            "namlik": f"{necessary_things[27].text}%",
                                            "yomgir yogish ehtimoli": f"{necessary_things[11].text}%"}, 
                                "12:00": {"harorat": necessary_things[4].text,
                                            "havo": weather[4].text,
                                            "shamol tezligi": f"{necessary_things[32].text}{m_taqsin_s[4].text}",
                                            "yogingarchilik": f"{necessary_things[20].text}{yogingarchilik[4].text}",
                                            "namlik": f"{necessary_things[28].text}%",
                                            "yomgir yogish ehtimoli": f"{necessary_things[12].text}%"},
                                "15:00": {"harorat": necessary_things[5].text,
                                            "havo": weather[5].text,
                                            "shamol tezligi": f"{necessary_things[32].text}{m_taqsin_s[5].text}",
                                            "yogingarchilik": f"{necessary_things[21].text}{yogingarchilik[5].text}",
                                            "namlik": f"{necessary_things[29].text}%",
                                            "yomgir yogish ehtimoli": f"{necessary_things[13].text}%"},
                                "18:00": {"harorat": necessary_things[6].text,
                                            "havo": weather[6].text,
                                            "shamol tezligi": f"{necessary_things[32].text}{m_taqsin_s[5].text}",
                                            "yogingarchilik": f"{necessary_things[22].text}{yogingarchilik[6].text}",
                                            "namlik": f"{necessary_things[30].text}%",
                                            "yomgir yogish ehtimoli": f"{necessary_things[14].text}%"},
